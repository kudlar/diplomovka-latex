...
\emph{public static byte[] \textbf{byteToByteArray()}}
...
\emph{public static byte[] \textbf{shortToByteArray()}}
...
\emph{public static byte[] \textbf{intToByteArray()}}
...
\emph{public static byte[] \textbf{longToByteArray()}}
...
\emph{public static byte[] \textbf{floatToByteArray()}}
...
\emph{public static byte[] \textbf{doubleToByteArray()}}
...
\emph{public static boolean \textbf{validateMAC()}}
