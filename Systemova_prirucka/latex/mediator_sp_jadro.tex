...
pokrývajú ka¾dý príklad pou¾itia sprostredkovania správ z kapitoly \ref{sec:mediator_examples}. 
...
Prvá fáza je znázornená na Obr. \ref{o:collecting1_schema} a predstavuje najni¾¹iu vrstvu celého 
...
buffera. Tieto údaje, spolu s IP adresou exportéra a èasom prijatia dát zabalí do objektu triedy
...
Schému druhej fázy mô¾eme vidie» na Obr. \ref{o:collecting2_schema}. Hlavná metóda \emph{run()} vlákna 
\verb|UDPProcessor| cyklicky vyberá dáta z \verb|PacketCache| a predáva ich \emph{parseru} - \verb|IPFIXParser|. 
...
Ka¾dej takto získanej in¹tancii sprostredkovateµského procesu zapí¹e do vstupného buffera 
