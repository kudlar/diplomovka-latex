...
%----------------DELENIE SLOV-------------
\hyphenation{kon-štruk-tor sek-ven-čné spros-tred-ko-va-teľ-ský spros-tred-ko-va-teľ-ské-mu IPFIX}
\hyphenation{kon-štruk-to-ra ná-roč-né spros-tred-ko-va-teľ-ský-mi na-vrh-nu-té-ho Feciľakovi}
\hyphenation{spros-tred-ko-va-teľ-skú spros-tred-ko-va-teľ-ské-ho spros-tred-ko-va-teľ-ských}
\hyphenation{spros-tred-ko-va-nia}
%-----------------------------------------
...
Technickej univerzite v~Košiciach predstavuje nástroj na pasívne meranie a analýzu parametrov prevádzky
...
%
% OK
%\includepdf[pages={1,2,3,4}]{mediator_sp.pdf}
% NEFUNGUJE
%\includepdf[pages=-]{mediator_sp.pdf}
%
%
\end{document}
%%