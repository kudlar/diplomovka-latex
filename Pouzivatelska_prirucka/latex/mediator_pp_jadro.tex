...
filtrovanie, selekciu, anonymizáciu 
...
\bigskip
Ak pou¾ívateµ nie je \emph{root}, je potrebné ma» v~systéme pridelené \emph{sudo} právo a Mediator 
spusti» príkazom:
...
Nie je mo¾né naèíta» konfiguraèný súbor. Treba sa uisti», èi súbor /etc/mediator/mediator.conf existuje, 
...
procesu. Chyby majú individuálne rie¹enie.\\
...
\end{verbatim}
\textbf{Popis a~rie¹enie:}
Do¹lo k preru¹eniu UDP Servera. Chyba má individuálne rie¹enie.\\
...
\end{verbatim}
\textbf{Popis a~rie¹enie:}
Nastala chyba pri vytváraní UDP socketu. Chyba ma individuálne rie¹enie.\\
...
\end{verbatim}
\textbf{Popis a~rie¹enie:}
Do¹lo k preru¹eniu UDP Exportéra. Chyba ma individuálne rie¹enie.\\
...
\noindent V~súèasnosti neboli v~programe Mediator 1.0 nájdené vá¾ne chyby.
...
funkcie pre kolektor. Spomeòme napríklad agregáciu, koreláciu, filtrovanie, selekciu CI anonymizáciu.
