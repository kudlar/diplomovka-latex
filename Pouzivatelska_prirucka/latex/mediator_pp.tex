...
pdftitle={Pou\v{z}\'ivate\v{l}sk\'a pr\'iru\v{c}ka Mediator v1.0},
...
\podnazov{}
\klucoveslova{IPFIX, Sprostredkovanie, Medi\'ator, Kolektor, Export\'er, SLAmeter, BasicMeter, MONICA}
\jazyk{slovenský}
\titul{In¾inier}
...
\kategoria{Príloha B}
%nazov prilohy
\dekan{POU\v{Z}\'IVATE\v{L}SK\'A PR\'IRU\v{C}KA Mediator v1.0}
%rok prilohy
\osnova{ 2013}
...
\mesto{Ko¹ice}
\cpriloha{Príloha B}
\tpriloha{POU\v{Z}\'IVATE\v{L}SK\'A PR\'IRU\v{C}KA Mediator v1.0}
